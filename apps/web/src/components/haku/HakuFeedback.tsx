  ...
  return (
    <aside className="feedback-panel haku-sidebar-inner">
      <div className="haku-brand">
        ...
        {roundNumber > 0 && (
          <span className="haku-round">Round {roundNumber}</span>
        )}
      </div>
      ...
      <div className="fp-cta">
        ...
        {isEmpty && !feedback && (
          <p className="fp-hint">
            Add your explanation, then ask Haku to check it.
          </p>
        )}
      </div>
      ...
      {!feedback && !loading && !error && (
        <div className="fp-welcome">
          ...
          <p>
            ...
            what&apos;s right, flag misconceptions, and nudge you — never just
            hand you the answer.
          </p>
        </div>
      )}
